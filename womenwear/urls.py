...
urlpatterns = [
    ...
    path('husbandEmbroideredkurta/', views.HusbandEmbroideredkurta, name='husbandEmbroideredkurtaind'),
    ...
    path('husbandKurtapajamaset/', views.HusbandKurtapajamaset, name='husbandKurtapajamasetind'),
    ...
    path('kidsgirlsLehengasets/', views.kidsgirlsLehengasets, name='kidsgirlsLehengasetsind'),
    path('kidsgirlsTops_Tunics/', views.kidsgirlsTops_Tunics, name='kidsgirlsTops_Tunicsind'),
    path('kidsgirlsNight_Wear/', views.kidsgirlsNight_Wear, name='kidsgirlsNight_Wearind'),
    ...
    path('Designer_Collection/', views.Designer_Collection, name='Designer_Collectionind'),
    ...
    path('signin/', auth_views.LoginView.as_view(next_page='homeind' ,template_name='../templates/india/signin.html', authentication_form=LoginForm) ,name="signinind"),
    path('logout/',auth_views.LogoutView.as_view(next_page='signinind'),name='logoutind'),
    path('profile/', views.ProfileView.as_view() , name='profileind'),
    path('changepassword/', auth_views.PasswordChangeView.as_view(template_name='../templates/india/changepassword.html',form_class=MyPasswordChangeForm,success_url='/passwordchangedone/') ,name="changepasswordind"),
    path('passwordchangedone/',auth_views.PasswordChangeDoneView.as_view(template_name='../templates/india/passwordchangedone.html'),name='passwordchangedoneind'),
    path('password-reset/',auth_views.PasswordResetView.as_view(template_name='../templates/india/password_reset.html',form_class=MypasswordResetForm),name='password_resetind'),
    path('password-reset-done/',auth_views.PasswordResetDoneView.as_view(template_name='../templates/india/password_reset_done.html'),name='password_reset_doneind'),
    path('password-reset-confirm/<uidb64>/<token>/',auth_views.PasswordResetConfirmView.as_view(template_name='../templates/india/password_reset_confirm.html',form_class=MySetPasswordForm),name='password_reset_confirmind'),
    path('password-reset-complete/',auth_views.PasswordResetCompleteView.as_view(template_name='../templates/india/password_reset_complete.html'),name='password_reset_completeind'),
